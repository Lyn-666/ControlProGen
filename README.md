...
```
conda create --name controlprogen python=3.10
conda activate controlprogen
```
   
2. install controlprogen
```
pip install git+https://github.com/Lyn-666/ControlProGen.git
```
